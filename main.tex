...
In support of the semantic actions occurring as they should, and requiring inputs of the same length, we use the construction of Harel~\cite{HAREL1987231} to build a particular \emph{cross product} of two FSMs.  For our example here, the resulting FSM is shown in Figure~\ref{fig:nimFSM}, which makes moves with the proper timing and appropriately distinguishes a win by~A from a win by~B.
