...
\paragraph{Advice} Following AOP terminology, advice specifies \emph{what} changes to the FSM will be applied at a joinpoint. The printing of available funds modifies the FSM by inserting a new state 
...
\begin{algorithm}
\caption{Construction of the Cross Product Machine}
