...
\begin{figure*}
    ...
    \caption{An example finite state machine that accepts 5 cent coins and dispenses peanuts.}
    \label{fig:vend1}
\end{figure*}
...
\begin{figure*}
    \centering
    \includegraphics[width=0.4\textwidth]{figures/nimexample/nimFSM.pdf}
