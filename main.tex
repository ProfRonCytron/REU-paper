...
\begin{figure}
    \centering
    \includegraphics[width=0.45\linewidth]{figures/VendingMachine.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.2\linewidth]{figures/nimexample/playerFSM.pdf}
    \caption{FSM specifying alternation of Players~A and~B.}
    \label{fig:nimPlayerFSM}
\end{figure}

Using a construction technique due to Harel~\cite{HAREL1987231} and well documented in Ptolomy~\cite{EdwardLee}, we obtain the basic game of Nim shown in Figure~\ref{fig:nimFSM}.  That algorithm simulates the simultaneous, lock-step execution of the machines shown in Figures~\ref{fig:nimHeapFSM} and~\ref{fig:nimPlayerFSM}.
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/cacheFSM.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{figures/cacheFSM2.pdf}
